<template>
  ...
  >
    <g>
      <g clip-path="url(#IconifyId-17827863df0-668978-4)">
        <path
          d="M11.385 15.275c1.111-.004 3.54-.013 3.512-1.558c-.027-1.58-2.36-1.485-3.497-1.438c-.127.005-.24.01-.332.011l.052 2.987c.075-.002.165-.002.265-.002z"
        />
        <path
          d="M11.267 10.922c.927-.001 2.95-.003 2.926-1.408c-.026-1.437-1.969-1.352-2.918-1.31c-.107.005-.2.009-.278.01l.047 2.709l.223-.001z"
        />
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
      ...
      <defs>
        <clipPath id="IconifyId-17827863df0-668978-4">
